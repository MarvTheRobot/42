...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/reference/flexsearch.min.js');loadScript('/reference/en.search-data.min.c1d8dc2678637a6a4afd8ddea50145a7965ba86284952803970eb0ad04f1afb1.js',function(){input.required=false;search();});}
